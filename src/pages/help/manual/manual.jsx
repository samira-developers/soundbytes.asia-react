                    ...
                    <div>
                        <div className="abstract"><h3 className="abstract-title"><em>Abstract</em></h3> <p>This document
                            ...
                            <div className="note"><h3 className="title">Documentation</h3> <p>The current version of this
                                document is available as a .pdf file at the following location; <a className="text-primary text-decoration-underline px-1 link" href={proppyPdf} target="_blank">doc/proppy.pdf</a>.
                            </p></div>
                        </div>
                    </div>
                </div>
